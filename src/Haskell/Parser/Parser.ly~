...
> %tokentype { Token }
  ...
  Modification: the adition of the infixed type constructor (^) makes necessary
  to introduce associativiti and precedence orer betwen the type construcotr 
  (^) and (->)
